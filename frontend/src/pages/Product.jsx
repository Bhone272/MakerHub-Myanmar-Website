  ...
  return productData ? (
    ...
    <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
      ...
      <div className='flex-1'>
        ...
        <p className='mt-5 text-gray-600 md:-4/5'>{productData.description}</p>
        <div className=' flex flex-col gap-4 my-8'>
          <p className='mt-5 text-2xl font-medium'>About Product</p>
          <p className='mt-5 text-xl text-gray-700 font-medium'>Category :{productData.category }</p> 
          <p className='mt-5 text-xl text-gray-700 font-medium'>SubCategory :{productData.subCategory }</p> 
        </div>
        ...
        <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
          <p>100% Original product.No fake! No Scam!</p>
